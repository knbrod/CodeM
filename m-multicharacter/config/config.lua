Config                   = {}
Config.Framework         = "qb"      -- esx, qb, oldqb
...
Config.SpawnSelector     = false --for esx : If you want to use ESX's Spawn Selector after the players clicks to " Continue " button from user interface set this value to true, if not set it to false.
